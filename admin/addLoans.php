...
<div class="container_12">
    ...
    <div class="grid_10">
        ...
        <div class="box round first grid">
            <h2> Add Loan</h2>
            <div class="block">
                <form action="loanCreate.php" method="post">
                    <div class="form-group">
                        <label for="name">Loan Name: </label>
                        <input class="form-control" type="text" id="name" name="name" placeholder="Loan Name">
                    </div>
                    <div class="form-group">
                        <label for="amount">Amount: </label>
                        <input class="form-control" type="text" id="amount" name="amount" placeholder="BDT">
                    </div>
                    <div class="form-group">
                        <label for="interest">Interest: </label>
                        <input class="form-control" type="text" id="interest" name="interest" placeholder="interest">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="loan_id" name="loan_id" placeholder="Loan ID">
                    </div>
                    <div class="form-group">
                        <label for="details">Details: </label>
                        <input class="form-control" type="text" id="details" name="details" placeholder="details">
                    </div>
