...
<div class="container_12">
    ...
    <div class="grid_10">
        ...
        <div class="box round first grid">
            <h2> Accounts Information For <?=$customer[0]['first_name'].' '.$customer[0]['last_name']?></h2>
            <div class="block">
                <form action="accountCreate.php" method="post">
                    <input type="hidden" name="customer_id" value="<?=$customer[0]['id']?>">
                    <div class="form-group">
                        <label for="account_no">Account Number: </label>
                        <input class="form-control" type="text" id="account_no" name="account_no" placeholder="Account Number">
                    </div>
                    <div class="form-group">
                        <label for="total_money">Deposit Money: </label>
                        <input class="form-control" type="text" id="total_money" name="total_money" placeholder="BDT">
                    </div>
